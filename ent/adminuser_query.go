...
func (_q *AdminUserQuery) Modify(modifiers ...func(s *sql.Selector)) *AdminUserSelect {
...
// Modify adds a query modifier for attaching custom logic to queries.
func (_s *AdminUserSelect) Modify(modifiers ...func(s *sql.Selector)) *AdminUserSelect {
